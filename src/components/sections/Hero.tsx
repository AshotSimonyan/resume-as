...
const HeroComponent = ({ data }: HeroProps) => (
  <section id="home">
    <p className="hero-pre fade">{data.copy.heroIntro}</p>
    ...
    <p
      className="hero-desc fade"
      style={{ transitionDelay: '.3s' }}
      dangerouslySetInnerHTML={{ __html: data.heroDescription }}
    />
    <a href={data.copy.heroCtaHref} className="hero-cta fade" style={{ transitionDelay: '.4s' }}>
      {data.copy.heroCtaLabel}
      <svg
        width="16"
        height="16"
        viewBox="0 0 24 24"
