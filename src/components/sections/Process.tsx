...
export const Process = ({ data }: ProcessProps) => (
  <section id="process">
    <h2 className="section-heading fade" data-n={data.copy.process.number}>
      {data.copy.process.title}
    </h2>
    <p className="process-subtitle fade">{data.copy.process.subtitle}</p>
